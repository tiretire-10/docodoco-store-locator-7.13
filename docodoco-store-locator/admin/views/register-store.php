    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            <div class="col-8">
                ...
                <div class="col">
                    <label for="inputPrefecture" class="form-label">都道府県</label>
                    <input type="text" class="form-control" id="inputPrefecture" name="prefecture" placeholder="東京都" value="<?php echo esc_attr(Helper::arr_get($data, 'prefecture')) ?>">
                    <div class="form-error"><?php echo esc_html(Helper::arr_get($view_form_errors, 'prefecture')) ?></div>
                </div>
                <div class="col">
                    <label for="inputMunicipalityName" class="form-label">市区町村</label>
                    <input type="text" class="form-control" id="inputMunicipalityName" name="municipality_name" placeholder="千代田区" value="<?php echo esc_attr(Helper::arr_get($data, 'municipality_name')) ?>">
                    <div class="form-error"><?php echo esc_html(Helper::arr_get($view_form_errors, 'municipality_name')) ?></div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="inputCategory" name="category">
                        <option value="municipality" <?php echo Helper::arr_get($data, 'category') === 'municipality' ? 'selected' : '' ?>>自治体</option>
                        <option value="hospital" <?php echo Helper::arr_get($data, 'category') === 'hospital' ? 'selected' : '' ?>>病院</option>
                    </select>
                    <div class="form-error"><?php echo esc_html(Helper::arr_get($view_form_errors, 'category')) ?></div>
                </div>
