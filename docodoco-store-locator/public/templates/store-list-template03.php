...
<div class="docodoco_store">
    <!--========== 一覧レイアウト03 ==========-->
    <div class="docodoco_store_index03">
        <!--========== 検索条件 ==========-->
        ...
        <!--========== 店舗リスト ==========-->
        <div class="docodoco_store_index03_column">
            <div class="docodoco_index_shop03">
                <div id="docodoco_store_list" class="docodoco_index_shop_item03">
                </div>
            </div>
        </div>

        <div class="docodoco_store_no_results" style="display: none;">
            条件に該当する店舗が見つかりませんでした。
        </div>
        
        <div id="temp_docodoco_store_list" style="display: none;">
            <?php foreach ($stores as $store) : ?>
                <div class="docodoco_index_shop_box02 js_docodoco_store_row" data-distance="999999" data-lat="<?php echo esc_attr($store->lat); ?>" data-lng="<?php echo esc_attr($store->lng); ?>" >
        ...
        <?php if ($is_map_display_enabled): ?>
            <div id="docodoco_store_map" class="docodoco_store_map map_size03"></div>
        <?php endif; ?>
        <!--========== /Map ==========-->
    ...
    function docodocoStoreLocator(surfpoint = {}) {
        ...
        */ 
        function displayStoreData(keyword = '', mode = DISPLAY_MODE.INIT) {
            ...
            const tempStoreListElement = document.querySelectorAll('#temp_docodoco_store_list .docodoco_index_shop_box02');
            ...
            // 表示店舗がない場合、メッセージを表示
            const recordCount = storeListElement.querySelectorAll('.docodoco_index_shop_box02').length;
            if (recordCount === 0) {
