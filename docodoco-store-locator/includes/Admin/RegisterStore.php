...
class RegisterStore {
    ...
    public function post_register_store() {
        ...
        $input_data['prefecture'] = sanitize_text_field(wp_unslash($_POST['prefecture']));                    // ← 追加
        $input_data['municipality_name'] = sanitize_text_field(wp_unslash($_POST['municipality_name']));
        ...
        $input_data['category'] = sanitize_text_field(wp_unslash($_POST['category']));
        $input_data['medical_service_url'] = sanitize_url(wp_unslash($_POST['medical_service_url']), array('http', 'https'));  // ← 追加
        $input_data['female_doctor'] = sanitize_text_field(wp_unslash($_POST['female_doctor']));                                // ← 追加
        $input_data['sunday_hours'] = sanitize_text_field(wp_unslash($_POST['sunday_hours']));                                  // ← 追加
        $input_data['online_booking'] = sanitize_text_field(wp_unslash($_POST['online_booking'])); 
        ...
        $form_data['prefecture'] = $input_data['prefecture'] === '' ? null : $input_data['prefecture'];                    // ← 追加
        $form_data['municipality_name'] = $input_data['municipality_name'] === '' ? null : $input_data['municipality_name'];
        ...
        $form_data['category'] = $input_data['category'] === '' ? 'municipality' : $input_data['category'];
        $form_data['medical_service_url'] = $input_data['medical_service_url'] === '' ? null : $input_data['medical_service_url'];  // ← 追加
        $form_data['female_doctor'] = $input_data['female_doctor'] === '' ? null : $input_data['female_doctor'];                    // ← 追加
        $form_data['sunday_hours'] = $input_data['sunday_hours'] === '' ? null : $input_data['sunday_hours'];                        // ← 追加
        $form_data['online_booking'] = $input_data['online_booking'] === '' ? null : $input_data['online_booking']; 
    ...
    public static function init_form_data($store_id) {
        ...
        $data = array(
            ...
            'prefecture' => $store->prefecture,                    // ← 追加
            ...
            'medical_service_url' => $store->medical_service_url,  // ← 追加
            'female_doctor' => $store->female_doctor,              // ← 追加
            'sunday_hours' => $store->sunday_hours,                // ← 追加
            'online_booking' => $store->online_booking,
