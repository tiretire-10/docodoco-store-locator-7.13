...
class Store {
    ...
    const LABELS = [
        ...
        'cost' => '費用',
        'category' => 'カテゴリー',
        'medical_service_url' => '検診専用URL',     
        'female_doctor' => '女医の担当',         
        'sunday_hours' => '日曜診療',  
        'online_booking' => 'ネット予約',  
        'prefecture' => '都道府県',              // ← 追加（2箇所目）
        'municipality_name' => '市区町村',
        'created_at' => '登録日',
        'updated_at' => '更新日'
    ];
    ...
    public static function create_table() {
        ...
        $sql = "CREATE TABLE `{$wpdb->prefix}docosl_stores` (
            ...
            `category` varchar(50) NULL DEFAULT 'municipality',
            `publish_status` int NOT NULL DEFAULT '1',
            `created_at` datetime NOT NULL,
            `medical_service_url` TEXT NULL,             
            `female_doctor` varchar(50) NULL,            
            `sunday_hours` varchar(100) NULL,            
            `online_booking` varchar(50) NULL,  
